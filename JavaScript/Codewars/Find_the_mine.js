...
// and the second element is the column index of the bomb location (both should be 0 based). All 2D arrays passed 
// into your function will be square (NxN), and there will only be one mine in the array.
