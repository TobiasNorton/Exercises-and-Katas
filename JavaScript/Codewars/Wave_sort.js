...
// Thus, the array [4, 1, 7, 5, 6, 2, 3] is in Wave order because 4 >= 1, then 1 <= 7, 
// then 7 >= 5, then 5 <= 6, then 6 >= 2, and finally 2 <= 3.
...
// it into wave order in place; your function shouldn't return anything.
