...
// the two arrays have the "same" elements, with the same multiplicities. "Same" means, here, that the 
...
function comp(array1, array2){
  ...
  const sames = sorted1.filter((number, index) => number * number === sorted2[index])
  return sames.length === sorted1.length
}
